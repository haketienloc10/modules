...
fun defaultModules(): List<ServiceModule> = listOf(
    ServiceModule(
        ...
        startCommand = "tmux new-session -d -s cliproxyapi-session 'clip-proxy-api'",
        stopCommand = "tmux kill-session -t cliproxyapi-session",
    ...
    ServiceModule(
        ...
        startCommand = "tmux new-session -d -s openclaw-gateway 'openclaw gateway'",
        stopCommand = "tmux kill-session -t openclaw-gateway",
